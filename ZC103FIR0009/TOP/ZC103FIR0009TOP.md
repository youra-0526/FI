``` abap
*&---------------------------------------------------------------------*
*& Include ZC103FIR0009TOP                          - Report ZC103FIR0009
*&---------------------------------------------------------------------*
REPORT zc103fir0009 MESSAGE-ID zmsgc103.
...
* TABLES
**********************************************************************
TABLES : zc103fit0019, zc103fit0002.
...
TYPES : BEGIN OF ty_sum,
          node_id     TYPE zc103fit0019-node_id,
          parent_node TYPE zc103fit0019-parent_node_id,
          node_name   TYPE zc103fit0019-node_name,
...
DATA : BEGIN OF gs_pldata.
         INCLUDE STRUCTURE zc103fit0019.
DATA :   prev_amt   TYPE zc103fit0002-wrbtr,   "전기금액
         ...
         percentage TYPE char10,                "변동률(%)
         cellcolor  TYPE lvc_t_scol, "변동률 cell color지정용
         excel_row  TYPE i,          "엑셀 pdf 출력용
       END OF gs_pldata,
       gt_pldata LIKE TABLE OF gs_pldata.

*-- For ALV top
DATA : gt_top LIKE TABLE OF gs_pldata,
       gs_top LIKE gs_pldata.
